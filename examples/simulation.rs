...
fn main() {
    ...
    dbi1.add(101, Decimal::from(0.543));    // 0.543
    dbi1.add(102, Decimal::from(0.120));    // 0.120 (explicitly 3 decimal places)
    dbi1.add(103, Decimal::from(0.12345));  // 0.12345 (will be binned as 0.123)
    ...
    dbi2.add(201, Decimal::from(0.543,));    // 0.54300
    dbi2.add(202, Decimal::from(0.12));      // 0.12000
    dbi2.add(203, Decimal::from(0.12345));   // 0.12345
